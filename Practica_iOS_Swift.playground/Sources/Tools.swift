...
public class Tool{
    ...
    public func getTheFirstHundredPrimeNumbers(){
...
//MARK: - EJERCICIO 2-
    ...
    /*
public func addTheFirst50PrimeNumbers(list: [Int]){
    var addition: Int = 0
    for prime in list.prefix(50){
        addition += prime
    }
    print("La suma de los 50 primeros números primos es \(addition)")
}
            */
    public func addTheFirst50PrimeNumbers(){
    var addition: Int = 0
    ...
    public func retrieveNamesWithMoreThanTwoVowels (namesList: [String]){
        ...
        print(namesWithMoreThanTwoVowelsList)
    }
